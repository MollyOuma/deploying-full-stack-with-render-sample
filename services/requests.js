...
const pool = new Pool({ // create connection to database
  connectionString: DATABASE_URL = postgres://activities_user:jUwbfdntD3ytgEQq1ClfXU7uu50v5KHy@dpg-clad7q62eqrc73992f5g-a/activity_database_z08r
    // use DATABASE_URL environment variable from Render app 
  ssl: {
